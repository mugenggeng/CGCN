...
class VideoEpisodicDataSet(data.Dataset):
    def __init__(self, opt, subset="val", mode="test"):
        ...
        self.video_info_path = "../gtadData/activitynet_annotations/video_info_new.csv"
        self.video_anno_path = "../gtadData/activitynet_annotations/anet_anno_action.json"
         # to do ---> same as self.data_list in RePri
        # self._get_match_map()
        self.istrimmed = opt["is_trimmed"]
        self.shot = opt["shot"] # to do
        # self.transform =  transform # to do 
        actions = pd.read_csv("../gtadData/activitynet_annotations/action_name.csv")
        ...
        # print(self.cnames)
        self.db = load_json("../gtadData/activitynet_annotations/anet_anno_action.json")
