...
class ANETdetection(object):
    ...
    def _import_ground_truth(self, ground_truth_filename):
        ...
        print(ground_truth_filename,'ground_truth_filename')
        with open(ground_truth_filename, 'r') as fobj:
            # print(ground_truth_filename,'ground_truth_filename')
            # print(fobj,'ground_truth_filename')
            data = json.load(fobj)
        # Checking format
        ...
        for videoid, v in data['database'].items():
            # print(videoid)
            if os.path.exists(os.path.join("../gtadData/activity_output/results2", "v_"+videoid + ".csv")):
                # print(v)
